...
\SE{CMake, Qt5, Gradle, OpenGL, HTML, Haskell, Racket}%
...
\begin{itemize}
	...
	\SE{\item Replicated prior binary analysis studies, modernizing tooling for current disassemblers and pipelines.}
...
\begin{itemize}
	\item Tutored peers taking the Computer Organization and programming systems course
	 \Cyber{\item Guided students in x86 assembly, basic ROP and overflow exploits, and memory and cache behavior.}

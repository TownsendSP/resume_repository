...
\Cyber{lldb, gdb, x64dbg, }\SE{CMake, Qt5, Gradle, OpenGL, HTML, \LaTeX, Haskell, Racket}\ML{, PyTorch, Tensorflow}\\
\textbf{Tools:} Microsoft Office, JetBrains IDEs, Binary Ninja, Ghidra, Frida, Burp Suite, Git, Unity, Visual Studio, Radare2
\Cyber{Ghidra, Frida, Burp Suite}\SE{Git, Unity, Visual Studio, Radare2}\ML{Ghidra, Tensorflow, PyTorch}\\

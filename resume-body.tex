...
\VariantContent{lldb, gdb, x64dbg}{CMake, Qt5, Gradle, OpenGL, HTML, \LaTeX, Haskell, Racket}{PyTorch, Tensorflow}\\
\textbf{Tools:} Microsoft Office, JetBrains IDEs, Binary Ninja, Ghidra, Frida, Burp Suite, Git, Unity, Visual Studio, Radare2
\VariantContent{Ghidra, Frida, Burp Suite}{Git, Unity, Visual Studio, Radare2}{Ghidra, Tensorflow, PyTorch}
